...
- [Anti-Korrupt](https://github.com/KezzyNgotho/Hackathon202409AI) - Leveraging the power of blockchain and AI to enhance learning to create an overall corruption-free environment all over the world.
